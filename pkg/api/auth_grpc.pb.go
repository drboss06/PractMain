...
const (
	Auth_CreateUser_FullMethodName  = "/api.Auth/CreateUser"
	Auth_AcceptUser_FullMethodName  = "/api.Auth/AcceptUser"
	Auth_DeleteUser_FullMethodName  = "/api.Auth/DeleteUser"
	Auth_GetUserById_FullMethodName = "/api.Auth/GetUserById"
)
...
func (c *authClient) AcceptUser(ctx context.Context, in *AcceptUserRequest, opts ...grpc.CallOption) (*AcceptUserResponse, error) {
	out := new(AcceptUserResponse)
	err := c.cc.Invoke(ctx, Auth_AcceptUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) AcceptUser(context.Context, *AcceptUserRequest) (*AcceptUserResponse, error) {
...
func _Auth_AcceptUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AcceptUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).AcceptUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_AcceptUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).AcceptUser(ctx, req.(*AcceptUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Auth_AcceptUser_Handler,
		},
		{
